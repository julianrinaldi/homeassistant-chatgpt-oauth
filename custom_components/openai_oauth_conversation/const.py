...
INTEGRATION_VERSION: Final = "1.11.0"
...
MAX_SCRIPT_TOOL_RESPONSE_CHARACTERS: Final = 16_000
...
# The hosted backend may gate newer models on this Codex-compatible identity.
# Keep both headers aligned with a released Codex version; updating a
# separately installed app/CLI cannot change requests made by this integration.
# Released version: https://learn.chatgpt.com/docs/changelog (0.155.1).
ORIGINATOR: Final = "codex_cli_rs"
CODEX_CLIENT_VERSION: Final = "0.155.1"
