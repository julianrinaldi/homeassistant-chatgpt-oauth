...
If HACS does not follow the repository redirect, remove only the HACS repository reference and add `https://github.com/julianrinaldi/homeassistant-chatgpt-oauth` as a custom integration repository. Do not delete the Home Assistant integration entry.
